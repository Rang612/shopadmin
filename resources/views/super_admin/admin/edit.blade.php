...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{route('admins.store')}}" method="post" id="adminForm" name="adminForm">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{$admin->name}}" type="text" name="name" id="name" class="form-control" placeholder="Name">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{$admin->email}}" type="text" name="email" id="email" class="form-control" placeholder="Email">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{$admin->phone}}" type="text" name="phone" id="phone" class="form-control" placeholder="Phone">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option {{ ($admin->status == 0)? 'selected' : '' }} value="0">Block</option>
                                    </select>
                                    <p></p>
                                </div>
                            </div>
