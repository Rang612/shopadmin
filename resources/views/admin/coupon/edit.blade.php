...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{route('coupons.update', $coupon->id)}}" method="post" id="discountForm" name="discountForm">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{$coupon->max_uses}}" type="text"  name="max_uses" id="max_uses" class="form-control" placeholder="Max Uses">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{$coupon->max_uses_user}}"  type="text"  name="max_uses_user" id="max_uses_user" class="form-control" placeholder="Max Uses Use">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" cols="30" rows="5">{{$coupon->description}}</textarea>
                                    <p></p>
                                </div>
                            </div>
                        </div>
