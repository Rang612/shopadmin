        ...
        try {
            ...
            if (!empty($request->image_id)) {
                ...
                if ($tempImage) {
                    ...
                    $destDir = public_path('uploads/category/');
                    ...
                    // Copy và resize
                    if (File::copy($srcPath, $destDir . $newImageName)) {
                        $img = Image::make($srcPath)->fit(450, 600, function ($c) {
                            $c->upsize();
                        });
                        $img->save($thumbDir . $newImageName);
